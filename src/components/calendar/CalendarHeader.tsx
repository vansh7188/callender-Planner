...
export function CalendarHeader({
  ...
  return (
    <header className="rounded-2xl border border-white/50 bg-white/75 p-6 shadow-soft backdrop-blur-lg sm:p-7">
      {/* Main title section */}
      <motion.div
        initial={{ opacity: 0, y: -12 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.28 }}
        className="mb-6 flex flex-col gap-4 border-b border-white/50 pb-6 lg:flex-row lg:items-end lg:justify-between"
      >
        <div className="flex-1">
          ...
          <motion.h1
            ...
            className="text-display text-4xl font-bold text-slate-900 sm:text-5xl"
          >
            {title}
          </motion.h1>
          <motion.p
      ...
      >
        ...
        <motion.div
          ...
          className="rounded-full border border-white/40 bg-white/60 px-4 py-2 text-xs font-semibold text-slate-600 shadow-pristine backdrop-blur-sm"
        >
